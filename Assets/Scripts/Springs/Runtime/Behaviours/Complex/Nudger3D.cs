...
{
    public class Nudger3D : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, ISelectHandler, IDeselectHandler
    {
        public BaseSpringBehaviour SpringBehaviour;
        private Button _button;

        public Vector3 NudgeAmount = new Vector3(50, 50, 50);
        ...
        public void Nudge()
        {
            ...
            (SpringBehaviour as INudgeable<Vector3>).Nudge(NudgeAmount * _nudgeVarianceAmount);
